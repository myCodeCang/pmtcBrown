...
public class UserUserinfoService extends CrudService<UserUserinfoDao, UserUserinfo> {
    ...
    public void save(UserUserinfo userUserinfo, boolean syncShop) throws RuntimeException {
        ...
        if (userUserinfo.getIsNewRecord()) {
            ...
            userUserinfo.setIsUsercenter("0");
...
//        paraMap.put("userBankAddress", userBankAddr);
    ...
    public UserUserinfo getByRemarks(String remarks){
        return dao.getByRemarks(remarks);
    }
}